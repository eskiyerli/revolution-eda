...
class createConfigViewDialogue(QDialog):
    def __init__(self, parent):
        ...
        viewGroupLayout.addRow(edf.boldLabel("Switch View Types:"), self.switchViews)
        self.stopViews = edf.longLineEdit()
        viewGroupLayout.addRow(edf.boldLabel("Stop View Types:"), self.stopViews)
